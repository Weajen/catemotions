...
button1.addEventListener("click", () => {
  ...
  document.getElementById("texte").innerHTML = "Le chat fait la teuf!!!";
...
button2.addEventListener("click", () => {
  ...
  document.getElementById("texte").innerHTML = "Le chat est tout tristou :(";
...
button3.addEventListener("click", () => {
  ...
  clearInterval(intervalParty);
  document.getElementById("texte").innerHTML = "Le chat est trop content!!";
...
button4.addEventListener("click", () => {
  ...
  clearInterval(intervalParty);
  document.getElementById("texte").innerHTML = "Le chat est pas content du tout >:( il fait la baston!!";
...
button5.addEventListener("click", () => {
  ...
  clearInterval(intervalParty);
  document.getElementById("texte").innerHTML = "Le chat est fatigué. On le laisse faire dodo :)";
